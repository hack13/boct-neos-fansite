    ...
    return (
        <div class="bg-stone-100 flex flex-col rounded-md outline-3 p-4">
            ...
            <div class="grid grid-flow-row grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 p-3">
                ...
                <div><Link to="/game/22-06-25-s2"><img src="https://vz-f755a29c-81b.b-cdn.net/8f08142f-3c3e-4edf-87ff-0ed9469fb66c/thumbnail_c3d66236.jpg" class="w-16 md:w-32 lg:w-48 rounded-md" alt="video-thumbnail" /></Link></div>
